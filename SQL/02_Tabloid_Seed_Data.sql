...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (11, 'testyMac', 'Testy', 'McTest', 'testy@moody.net', '2020-03-01', 'https://robohash.org/voluptatemexercitationemdignissimos.png?size=150x150&set=set1', 1, 'ivfPPip1hPgg0e9JdSf63NRhaCq1');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (12, 'gubbo', 'Gubbins', 'McDoogal', 'gubbinsmcdoogal@gmail.com', '2020-04-14', 'https://robohash.org/voluptatemexercitationemdignissimos.png?size=150x150&set=set1', 1, '61JQdNqVQpTrPN79XqAAuQx9i0F2');
