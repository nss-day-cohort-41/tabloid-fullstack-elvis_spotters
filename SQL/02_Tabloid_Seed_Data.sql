...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (1, 'rsandwith0', 'Reina', 'Sandwith', 'test@test.com', '2020-04-23', 'https://robohash.org/numquamutut.png?size=150x150&set=set1', 1, '5L9cdya9oiXTpJmP7tpkDIb2u1D3');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (2, 'rdo1', 'Red', 'Do', 'user2@test.com', '2020-04-20', 'https://robohash.org/nisiautemet.png?size=150x150&set=set1', 2, 'KHdaMiywvzLPOJ5xvB1AHODJt3D3');
...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (11, 'testyMac', 'Testy', 'McTest', 'testy@moody.net', '2020-03-01', 'https://robohash.org/voluptatemexercitationemdignissimos.png?size=150x150&set=set1', 1, '61JQdNqVQpTrPN79XqAAuQx9i0F2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (12, 'gubbo', 'Gubbins', 'McDoogal', 'gubbinsmcdoogal@gmail.com', '2020-04-14', 'https://robohash.org/voluptatemexercitationemdignissimos.png?size=150x150&set=set1', 1, 'ivfPPip1hPgg0e9JdSf63NRhaCq1');
